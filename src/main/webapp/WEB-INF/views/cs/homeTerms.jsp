                                            ...
                                            <div class="agreed_txt_wrap">
                                                <div class="agreed_txt">
                                                    ...
                                                    <div class="agree_title">
                                                        <ul>
                                                            <li class="agreed_txt_tit form-footer" style="font-size: 20px; justify-content: center; padding-top: 30px;">제1장 총칙</li>
                                                        </ul>
                                                    </div>
                                                    
                                                    <div class="agree_title_sub">
                                                        <ul>
                                                            <li class="agreed_txt_tit_s form-footer">1 목적</li>
                                                        </ul>
                                                    </div>
                                                    ...
                                                    <div class="agree_title_sub">
                                                        <ul>
                                                            <li class="agreed_txt_tit_s form-footer">2 용어의 정의</li>
                                                        </ul>
                                                    </div>
                                                    <div class="agree_content">
                                                    ...
                                                    <div class="agree_title_sub">
                                                        <ul>
                                                            <li class="agreed_txt_tit_s form-footer">3 약관의 효력과 변경</li>
                                                        </ul>
                                                    </div>
                                                    <div class="agree_content">
                                                        <ul class="form-footer">
                                                    ...
                                                    <div class="agree_title_sub">
                                                        <ul>
                                                            <li class="agreed_txt_tit_s form-footer">4 약관 외 준칙</li>
                                                        </ul>
                                                    </div>
                                                    <div class="agree_content">
                                                        <ul>
                                                    ...
                                                    <div class="agree_title">
                                                        <ul>
                                                            <li class="agreed_txt_tit form-footer" style="font-size: 20px; justify-content: center; padding-top: 30px;">제2장 서비스 이용</li>
                                                        </ul>
                                                    </div>
                                                    <div class="agree_title_sub">
                                                        <ul>
                                                            <li class="agreed_txt_tit_s form-footer">5 이용가입의 성립</li>
                                                        </ul>
                                                    </div>
                                                    ...
                                                    <div class="agree_title_sub">
                                                        <ul>
                                                            <li class="agreed_txt_tit_s form-footer">6 회원정보 사용에 대한 동의</li>
                                                        </ul>
                                                    </div>
                                                    <div class="agree_content form-footer">
                                                        <ul>
                                                    ...
                                                    <div class="agree_title_sub">
                                                        <ul>
                                                            <li class="agreed_txt_tit_s form-footer">7 회원의 정보보안</li>
                                                        </ul>
                                                    </div>
                                                    <div class="agree_content">
                                                        <ul class="form-footer">
                                                    ...
                                                    <div class="agree_title_sub">
                                                        <ul>
                                                            <li class="agreed_txt_tit_s form-footer">8 서비스 이용시간</li>
                                                        </ul>
                                                    </div>
                                                    <div class="agree_content">
                                                        <ul class="form-footer">
                                                    ...
                                                    <div class="agree_title_sub">
                                                        <ul>
                                                            <li class="agreed_txt_tit_s form-footer">9 서비스의 중지</li>
                                                        </ul>
                                                    </div>
                                                    <div class="agree_content">
                                                        <ul class="form-footer">
                                                    ...
                                                    <div class="agree_title_sub">
                                                        <ul>
                                                            <li class="agreed_txt_tit_s form-footer">10 연계사이트 이용</li>
                                                        </ul>
                                                    </div>
                                                    <div class="agree_content">
                                                        <ul class="form-footer">
                                                            ...
                                                            <li><span class="frt_num">2.</span> 연계사이트는 행정안전부의
                                                                다사자규 포털 운영 관련 정책의 변경, 개별 사이트의 사정에 따라 추가 또는 제외될 수 있으며,
                                                    ...
                                                    <div class="agree_title_sub">
                                                        <ul>
                                                            <li class="agreed_txt_tit_s form-footer">11 다사자규 포털의 의무</li>
                                                        </ul>
                                                    </div>
                                                    <div class="agree_content">
                                                        <ul class="form-footer">
                                                    ...
                                                    <div class="agree_title_sub">
                                                        <ul>
                                                            <li class="agreed_txt_tit_s form-footer">12 회원의 의무 및 서비스 이용제한</li>
                                                        </ul>
                                                    </div>
                                                    <div class="agree_content form-footer">
                                                        <ul>
                                                    ...
                                                    <div class="agree_title_sub">
                                                        <ul>
                                                            <li class="agreed_txt_tit_s form-footer">13 다사자규 포털의 소유권</li>
                                                        </ul>
                                                    </div>
                                                    <div class="agree_content">
                                                        <ul class="form-footer">
                                                    ...
                                                    <div class="agree_title_sub">
                                                        <ul>
                                                            <li class="agreed_txt_tit_s form-footer">14 양도금지</li>
                                                        </ul>
                                                    </div>
                                                    <div class="agree_content">
                                                        <ul>
                                                    ...
                                                    <div class="agree_title_sub">
                                                        <ul>
                                                            <li class="agreed_txt_tit_s form-footer">15 손해배상</li>
                                                        </ul>
                                                    </div>
                                                    <div class="agree_content">
                                                        <ul>
                                                    ...
                                                    <div class="agree_title_sub">
                                                        <ul>
                                                            <li class="agreed_txt_tit_s form-footer">16 면책조항</li>
                                                        </ul>
                                                    </div>
                                                    <div class="agree_content">
                                                        <ul class="form-footer">
                                                    ...
                                                    <div class="agree_title_sub">
                                                        <ul>
                                                            <li class="agreed_txt_tit_s form-footer">17 관할법원</li>
                                                        </ul>
                                                    </div>
                                                    <div class="agree_content">
                                                        <ul class="form-footer">
                                                    ...
                                                    <div class="agree_title_sub">
                                                        <ul>
                                                            <li class="agreed_txt_tit_s form-footer">18 약관시행</li>
                                                        </ul>
                                                    </div>
                                                    <div class="agree_content">
                                                        <ul>
                                                            <li class="frt_txt">본 약관은 2024년 3월 29일부터 시행됩니다.</li>
                                                        </ul>
                                                    </div>
                                                </div><!-- End .agreed_txt -->
                                            </div><!-- End agreed_txt_wrap -->
                                        </div>
                                    </div>
                                </div>
                            </div>
