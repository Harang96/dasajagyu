					...
					<div class="toolbox">
						<div class="toolbox-left">
			               <ol class="breadcrumb">
				       			...
				       			<li class="breadcrumb-item active" aria-current="page">추천 상품</li>
				      		</ol>
					...
					<nav aria-label="Page navigation">
					    <ul class="pagination justify-content-center">
					        <c:choose>
					            ...
					            <c:otherwise>
					                <li class="page-item">
					                    <a class="page-link page-link-prev" href="viewMDList?pageNo=${pageNo - 1}" aria-label="Previous" tabindex="-1" aria-disabled="true">
					                        <span aria-hidden="true">
					                        	<i class="icon-long-arrow-left"></i>
					                        </span>Prev
					                    </a>
					            ...
					            <c:choose>
					                ...
					                <c:otherwise>
					                    <li class="page-item" aria-current="page">
					                        <a class="page-link" href="viewMDList?pageNo=${paging}">${paging}</a>
					                    </li>
					                </c:otherwise>
					            </c:choose>
					        </c:forEach>
					        <c:choose>
					            <c:when test="${pageNo < pagingInfo.totalPageCnt}">
					                <li class="page-item">
					                    <a class="page-link page-link-next" href="viewMDList?pageNo=${pageNo + 1}">Next
					                    	<span aria-hidden="true">
    ...
    <script type="text/javascript">
        ...
        $(function (){
	        $("#searchType").change(function(){
	    	    location.href="/product/viewMDList?&searchType=" + $(this).val();
	        })
        });
    </script>
</body>
