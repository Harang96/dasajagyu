				...
				<div class="container-fluid">
						...
						<div class="toolbox-left">
		                    <ol class="breadcrumb">
		          		        ...
		          		        <li class="breadcrumb-item">
		               			...
		               			<li class="breadcrumb-item active" aria-current="page">할인 상품</li>
		              		</ol>
						...
						<div class="toolbox-right">
							<div class="toolbox-sort">
								<div class="select-custom">
									<select name="searchType" id="searchType" class="form-control" onclick="searchType()">
					...
					<nav aria-label="Page navigation">
					    <ul class="pagination justify-content-center">
					        <c:choose>
					            <c:when test="${pageNo == 1 or param.pageNo == null}">
					            ...
					            <c:otherwise>
					                <li class="page-item">
					                    <a class="page-link page-link-prev" href="viewDCList?pageNo=${pageNo - 1}" aria-label="Previous" tabindex="-1" aria-disabled="true">
				                        	<span aria-hidden="true">
				                        		<i class="icon-long-arrow-left"></i>
				                        	</span>
				                        	이전
					            ...
					            <c:choose>
					                ...
					                <c:otherwise>
					                    <li class="page-item" aria-current="page">
					                        <a class="page-link" href="viewDCList?pageNo=${paging}">${paging}</a>
					                    </li>
					                </c:otherwise>
					            </c:choose>
					        </c:forEach>
				        	<c:choose>
					            <c:when test="${pageNo < pagingInfo.totalPageCnt}">
					                <li class="page-item">
					                    <a class="page-link page-link-next" href="viewDCList?pageNo=${pageNo + 1}">
					                    	다음
					                    	<span aria-hidden="true">
    ...
    <script type="text/javascript">
        ...
        $(function (){
	        $("#searchType").change(function(){
	    	    location.href="/product/viewDCList?&searchType=" + $(this).val();
	        })
        });
    </script>
</body>
