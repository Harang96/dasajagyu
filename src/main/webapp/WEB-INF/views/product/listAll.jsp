				...
				<div class="container-fluid">
						...
						<div class="toolbox-left">
		                    <ol class="breadcrumb">
        		                <li class="breadcrumb-item"><a href="/">홈</a></li>
	               		        ...
	               		        <c:if test="${original.className != null}">
	               		        	<li class="breadcrumb-item active" aria-current="page">${original.className}</li>
	               		        </c:if>
	                   		</ol>
					...
					<div class="container justify-content-md-center category-style">
	                    <div><!-- 첫 째 줄 시작 -->
	            	        <div class="category-dropdown">
		                        <div class="header-dropdown col">
		                            <a class="category-title" href="#">ㄱ</a>
		                            <div class="header-menu">
		                                <ul>
                          				 	<c:forEach var="origin" items="${originals}">
				                            	<c:if test = "${fn:contains(origin.originalClass, 'A')}">
													<li>
														<a href="listAll?originalClass=${origin.originalClass}">${origin.className }</a>
				                             	   	</li>
				                            	</c:if>
			                            	</c:forEach>
			                            </ul>
		                        ...
		                        <div class="header-dropdown col">
		                            <a class="category-title" href="#">ㄴ</a>
		                            <div class="header-menu">
		                                <ul>
                          				 	<c:forEach var="origin" items="${originals}">
				                            	<c:if test = "${fn:contains(origin.originalClass, 'B')}">
				                             		<li>
				                             	   		<a href="listAll?originalClass=${origin.originalClass}">${origin.className }</a>
				                             	   </li>
				                            	</c:if>
		                        ...
		                        <div class="header-dropdown col">
		                            <a class="category-title" href="#">ㄷ</a>
		                            <div class="header-menu">
		                                <ul>
                          				 	<c:forEach var="origin" items="${originals}">
				                            	<c:if test = "${fn:contains(origin.originalClass, 'C')}">
				                             		<li>
				                             	   		<a href="listAll?originalClass=${origin.originalClass}">${origin.className }</a>
				                             		</li>
				                            	</c:if>
		                        ...
		                        <div class="header-dropdown col">
		                            <a class="category-title" href="#">ㄹ</a>
		                            <div class="header-menu">
		                                <ul>
                          				 	<c:forEach var="origin" items="${originals}">
				                            	<c:if test = "${fn:contains(origin.originalClass, 'D')}">
				                             		<li>
				                             			<a href="listAll?originalClass=${origin.originalClass}">${origin.className }</a>
				                             		</li>
				                            	</c:if>
		                        ...
		                        <div class="header-dropdown col">
		                            <a class="category-title" href="#">ㅁ</a>
		                            <div class="header-menu">
		                                <ul>
                          				 	<c:forEach var="origin" items="${originals}">
				                            	<c:if test = "${fn:contains(origin.originalClass, 'E')}">
				                             		<li>
				                             			<a href="listAll?originalClass=${origin.originalClass}">${origin.className }</a>
				                             		</li>
				                            	</c:if>
		                        ...
		                        <div class="header-dropdown col">
		                            <a class="category-title" href="#">ㅂ</a>
		                            <div class="header-menu">
		                                <ul>
                          				 	<c:forEach var="origin" items="${originals}">
				                            	<c:if test = "${fn:contains(origin.originalClass, 'F')}">
				                             		<li>
				                             			<a href="listAll?originalClass=${origin.originalClass}">${origin.className }</a>
				                             		</li>
				                            	</c:if>
                    	...
                    	<div><!-- 두 번째 줄 시작 -->
	                    	<div class="category-dropdown">
								<div class="header-dropdown col">
	                            	<a class="category-title" href="#">ㅅ</a>
		                          	<div class="header-menu">
		                             	<ul>
                          				 	<c:forEach var="origin" items="${originals}">
				                            	<c:if test = "${fn:contains(origin.originalClass, 'G')}">
				                             		<li>
				                             			<a href="listAll?originalClass=${origin.originalClass}">${origin.className }</a>
				                             		</li>
				                            	</c:if>
	           		        	...
	           		        	<div class="header-dropdown col">
	                            	<a class="category-title" href="#">ㅇ</a>
		                            <div class="header-menu">
			                            <ul>
	                   				 		<c:forEach var="origin" items="${originals}">
				                            	<c:if test = "${fn:contains(origin.originalClass, 'H')}">
				                             		<li>
				                             			<a href="listAll?originalClass=${origin.originalClass}">${origin.className }</a>
				                             		</li>
				                            	</c:if>
		                        ...
		                        <div class="header-dropdown col">
	                            	<a class="category-title" href="#">ㅈ~ㅊ</a>
		                            <div class="header-menu">
		                                <ul>
                          				 	<c:forEach var="origin" items="${originals}">
			                            	<c:if test = "${fn:contains(origin.originalClass, 'I')}">
			                             	   <li>
			                             			<a href="listAll?originalClass=${origin.originalClass}">${origin.className }</a>
			                             		</li>
			                            	</c:if>
		                        ...
		                        <div class="header-dropdown col">
	                            	<a class="category-title" href="#">ㅋ~ㅌ</a>
		                            <div class="header-menu">
		                                <ul>
                          				 	<c:forEach var="origin" items="${originals}">
			                            	<c:if test = "${fn:contains(origin.originalClass, 'J')}">
			                             	   <li class=""><a href="listAll?originalClass=${origin.originalClass}">${origin.className }</a></li>
			                            	</c:if>
			                            	</c:forEach>
			                            </ul>
		                            </div><!-- End .header-menu -->
		                        ...
		                        <div class="header-dropdown col">
	                            	<a class="category-title" href="#">ㅍ~ㅎ</a>
		                            <div class="header-menu">
		                                <ul>
                          				 	<c:forEach var="origin" items="${originals}">
			                            	<c:if test = "${fn:contains(origin.originalClass, 'K')}">
			                             	   <li class=""><a href="listAll?originalClass=${origin.originalClass}">${origin.className }</a></li>
			                            	</c:if>
			                            	</c:forEach>
			                            </ul>
            								...
            								<div class="header-dropdown col">
	                            	<a class="category-title" href="#">ETC</a>
		                            <div class="header-menu">
		                                <ul>
                          				 	<c:forEach var="origin" items="${originals}">
			                            	<c:if test = "${fn:contains(origin.originalClass, 'L')}">
			                             	   <li class=""><a href="listAll?originalClass=${origin.originalClass}">${origin.className }</a></li>
			                            	</c:if>
			                            	</c:forEach>
			                            </ul>
										...
										<div class="product-body">
											...
											<h3 class="product-title">
												<span class="point-color">
													<span>&lt;</span>${product.classType }<span>&gt;</span>
													 ${product.classMonth }
												</span>
												<br>
					...
					<nav aria-label="Page navigation">
					    <ul class="pagination justify-content-center">
					        <c:choose>
					            ...
					            <c:otherwise>
					                <li class="page-item">
					                    <a class="page-link page-link-prev" href="listAll?pageNo=${pageNo - 1}&originalClass=${original.originalClass}" aria-label="Previous" tabindex="-1" aria-disabled="true">
					                        <span aria-hidden="true">
					                        	<i class="icon-long-arrow-left"></i>
					                        </span>이전
					                    </a>
					            ...
					            <c:choose>
					                ...
					                <c:otherwise>
					                    <li class="page-item" aria-current="page">
					                        <a class="page-link" href="listAll?pageNo=${paging}&originalClass=${original.originalClass}">${paging}</a>
					                    </li>
					                </c:otherwise>
					            </c:choose>
					        </c:forEach>
					        <c:choose>
					            <c:when test="${pageNo < pagingInfo.totalPageCnt}">
					                <li class="page-item">
					                    <a class="page-link page-link-next" href="listAll?pageNo=${pageNo + 1}&originalClass=${original.originalClass}">다음
					                    	<span aria-hidden="true">
    ...
    <script type="text/javascript">
        ...
        $(function () {
	        $("#searchType").change(function(){
	    	    location.href="/product/listAll?originalClass=" + '${original.originalClass}' + "&searchType=" + $(this).val();
	        });
