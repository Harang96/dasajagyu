...
<html 
  ...
  <body>
	               ...
	               <div class="card col-lg-7">
	                 <div class="card-datatable table-responsive">
	                   <table class="datatables-category-list table border-top">
	                     <thead>
	                       <tr>
	                         <th class="text-nowrap text-sm-end">관리 번호</th>
	                         <th class="text-nowrap text-sm-end">이름</th>
	                         <th></th>
	                       </tr>
	                     </thead>
	                   </table>
	               ...
	               <div class="col-12 col-lg-5">
	                 <div class="card mb-4">
	                   <div class="card-header py-4">
	                   	<h5 class="offcanvas-title">신규 제조사 추가</h5>
	                   </div>
	                 <div class="card-body border-top">
	                   <form action="addManufacturer" method="post" class="pt-0" id="addManufacturer">
	                     <!-- Title -->
	                     <div class="mb-3">
	                       <label class="form-label" for="addManufacturerName">제조사명</label>
	                       <input type="text" class="form-control" id="addManufacturerName" placeholder="ex) 다사쟈규" name="manufacturerName"/>
	                     </div>
	                     <!-- Submit and reset -->
	                     <div class="mb-3">
	                       <button type="submit" class="btn btn-primary me-sm-3 me-1 data-submit" onclick="return checkManufacturer('addManufacturerName')">추가</button>
	                       <button type="reset" class="btn bg-label-danger">취소</button>
	                     </div>
	                   </form>
	                 </div>
	                <div class="card-header py-4">
	                  <h5 class="offcanvas-title">제조사 수정</h5>
				    </div>
	                <div class="card-body border-top">
	                  <form action="updateManufacturer" method="post" class="pt-0" id="updateManufacturer">
					  <!-- Parent category -->
	                     <div class="mb-3 ecommerce-select2-dropdown">
	                       <label class="form-label" for="updateManufacturerNo">제조사 이름</label>
	                       <select id="updateManufacturerNo" class="select2 form-select" data-placeholder="제조사 이름" name="manufacturerNo" onchange="checkManufacturer('updateManufacturerNo')">
	                         <option value="">제조사 이름</option>
	                     ...
	                     <div class="mb-3">
	                       <label class="form-label" for="updateManufacturerName">변경할 이름</label>
	                       <input type="text" id="updateManufacturerName" class="form-control" placeholder="ex) 다팔자규" name="manufacturerName" onchange="checkManufacturer('updateManufacturerName')"/>
	                     </div>
	                     <!-- Submit and reset -->
	                     <div class="mb-3">
	                       <button type="submit" class="btn btn-primary me-sm-3 me-1 data-submit" onclick="return valicateUpdateManu('updateManufacturerNo','updateManufacturerName')">수정</button>
	                       <button type="reset" class="btn bg-label-danger">취소</button>
	                     </div>
	                   </form>
	                 </div>
    ...
    <!-- Page JS -->
    <script src="/resources/js/product/manufacturer-list.js"></script>
